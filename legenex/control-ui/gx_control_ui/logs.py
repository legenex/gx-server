...
STREAMS: tuple[Stream, ...] = (
    ...
    Stream("git-autosync", "Git autosync (node 1)", "node1", "file", "/srv/logs/gx-git-sync/node1-autosync.log", "Git"),
    Stream("git-push-failures", "Git push failures (node 1)", "node1", "file",
           "/srv/logs/gx-git-sync/push-failures.log", "Git"),
    Stream("git-reconcile", "Git reconcile (node 2)", "node2", "file", "/srv/logs/gx-git-sync/node2-reconcile.log", "Git"),
    Stream("audit-node1", "Daily integrity audit (node 1)", "node1", "file", "/srv/logs/gx-git-sync/audit-latest.log", "Git"),
    Stream("audit-node2", "Daily integrity audit (node 2)", "node2", "file", "/srv/logs/gx-git-sync/audit-latest.log", "Git"),
    ...
    Stream("control-ui", "control UI service", "node1", "file", "/srv/logs/gx-control-ui/control-ui.log", "Control plane"),
    Stream("control-ui-audit", "control UI audit trail", "node1", "file", "/srv/logs/gx-control-ui/audit.log", "Control plane"),
)
